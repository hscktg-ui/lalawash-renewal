  ...
  return (
    <>
      ...
      <section className="relative min-h-[78svh] overflow-hidden text-white md:min-h-[84svh]">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(11,31,46,0.32)_0%,rgba(11,31,46,0.20)_42%,rgba(11,31,46,0.68)_100%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(11,31,46,0.36)_0%,rgba(11,31,46,0.10)_48%,transparent_74%)]" />
