        ...
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              desc: '단일 세척장으로 감당하기 힘든 대형 지역 축제나 대기업 사내 카페의 물량도 21개 세척장의 유기적인 협업 시스템을 통해 딜레이 없이 소화합니다.',
            },
            {
              title: '어디서나 동일한 안심 청결',
              desc: '전 지점에 라라워시 6단계 안심 세척 매뉴얼과 ATP 오염도 측정을 동일하게 적용합니다. 경기도 어느 지역에서 이용하시더라도 최고 수준의 청결함을 경험하실 수 있습니다.',
            },
          ].map((x) => (
